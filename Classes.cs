...
namespace Box
{
    ...
    public class main
    {
        ...
        static void Main(string[] args)
        {
            ...
            Employee emp2 = new Employee("samer", 477912594,8000);
            Employee emp3 = new Employee("jeris", 467828252,15000);
            Employee emp4 = new Employee("majd", 460158931,17000);
